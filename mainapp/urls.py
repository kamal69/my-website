...
urlpatterns = [
    ...
    path('add-dealer/', views.add_dealer_view, name='add_dealer'),
    path('edit-dealer/<int:dealer_id>/', views.edit_dealer_view, name='edit_dealer'),
    path('delete-dealer/<int:dealer_id>/', views.delete_dealer_view, name='delete_dealer'),
